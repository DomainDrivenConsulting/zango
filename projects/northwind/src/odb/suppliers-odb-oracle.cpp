...
#include "zango/northwind/odb/suppliers-odb-oracle.hxx"
...
namespace odb
{
  ...
  struct access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::id_type
  access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::
  ...
  void access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::
  bind (oracle::bind* b,
        image_type& i,
  ...
  const char access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::find_statement[] =
  "SELECT "
  ...
  const char access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::update_statement[] =
  ...
  const char access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::erase_statement[] =
  "DELETE FROM \"NORTHWIND\".\"SUPPLIERS\" "
  "WHERE \"SUPPLIER_ID\"=:1";

  const char access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::query_statement[] =
  "SELECT "
  "\"NORTHWIND\".\"SUPPLIERS\".\"SUPPLIER_ID\", "
  "\"NORTHWIND\".\"SUPPLIERS\".\"COMPANY_NAME\", "
  "\"NORTHWIND\".\"SUPPLIERS\".\"CONTACT_NAME\", "
  ...
  const char access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::erase_query_statement[] =
  "DELETE FROM \"NORTHWIND\".\"SUPPLIERS\"";

  const char access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::table_name[] =
  "\"NORTHWIND\".\"SUPPLIERS\"";
  ...
  access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::pointer_type
  access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::
  ...
  bool access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::
  ...
  result< access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::object_type >
  access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::
  ...
  unsigned long long access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >::
