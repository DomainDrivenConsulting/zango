...
namespace odb
{
  ...
  bool access::composite_value_traits< ::zango::northwind::customer_type_id, id_pgsql >::
  grow (image_type& i,
        bool* t)
  {
  ...
  void access::composite_value_traits< ::zango::northwind::customer_type_id, id_pgsql >::
  bind (pgsql::bind* b,
        image_type& i,
