...
#include "zango/northwind/odb/customer_demographics-odb-oracle.hxx"
...
namespace odb
{
  ...
  struct access::object_traits_impl< ::zango::northwind::customer_demographics, id_oracle >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::zango::northwind::customer_demographics, id_oracle >::id_type
  access::object_traits_impl< ::zango::northwind::customer_demographics, id_oracle >::
  ...
  "(\"customer_type_id_customer_type\", "
  ...
  "SELECT "
  "\"northwind\".\"customer_demographics\".\"customer_type_id_customer_type\", "
  "\"northwind\".\"customer_demographics\".\"customer_description\" "
  "FROM \"northwind\".\"customer_demographics\" "
  "WHERE \"northwind\".\"customer_demographics\".\"customer_type_id_customer_type\"=:1";
  ...
  "WHERE \"customer_type_id_customer_type\"=:2";
  ...
  "WHERE \"customer_type_id_customer_type\"=:1";
  ...
  access::object_traits_impl< ::zango::northwind::customer_demographics, id_oracle >::pointer_type
  access::object_traits_impl< ::zango::northwind::customer_demographics, id_oracle >::
  ...
  bool access::object_traits_impl< ::zango::northwind::customer_demographics, id_oracle >::
  ...
  result< access::object_traits_impl< ::zango::northwind::customer_demographics, id_oracle >::object_type >
  access::object_traits_impl< ::zango::northwind::customer_demographics, id_oracle >::
  ...
  unsigned long long access::object_traits_impl< ::zango::northwind::customer_demographics, id_oracle >::
      ...
      switch (pass)
      {
        case 1:
        {
          db.execute ("CREATE TABLE \"northwind\".\"customer_demographics\" (\n"
                      "  \"customer_type_id_customer_type\" VARCHAR2(512) NOT NULL PRIMARY KEY,\n"
