...
namespace odb
{
  ...
  struct access::object_traits_impl< ::zango::northwind::supplier, id_pgsql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::zango::northwind::supplier, id_pgsql >::id_type
  access::object_traits_impl< ::zango::northwind::supplier, id_pgsql >::
  ...
  bool access::object_traits_impl< ::zango::northwind::supplier, id_pgsql >::
  grow (image_type& i,
        bool* t)
  {
  ...
  access::object_traits_impl< ::zango::northwind::supplier, id_pgsql >::pointer_type
  access::object_traits_impl< ::zango::northwind::supplier, id_pgsql >::
  ...
  result< access::object_traits_impl< ::zango::northwind::supplier, id_pgsql >::object_type >
  access::object_traits_impl< ::zango::northwind::supplier, id_pgsql >::
  ...
  unsigned long long access::object_traits_impl< ::zango::northwind::supplier, id_pgsql >::
      ...
      switch (pass)
      {
        case 1:
        {
          db.execute ("CREATE TABLE \"northwind\".\"supplier\" (\n"
                      "  \"supplier_id_supplier_id\" INTEGER NOT NULL PRIMARY KEY,\n"
