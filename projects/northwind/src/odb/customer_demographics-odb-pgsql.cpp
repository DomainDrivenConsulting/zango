...
namespace odb
{
  ...
  struct access::object_traits_impl< ::zango::northwind::customer_demographics, id_pgsql >::extra_statement_cache_type
  {
  ...
  access::object_traits_impl< ::zango::northwind::customer_demographics, id_pgsql >::id_type
  access::object_traits_impl< ::zango::northwind::customer_demographics, id_pgsql >::
  ...
  bool access::object_traits_impl< ::zango::northwind::customer_demographics, id_pgsql >::
  grow (image_type& i,
        bool* t)
  {
  ...
  access::object_traits_impl< ::zango::northwind::customer_demographics, id_pgsql >::pointer_type
  access::object_traits_impl< ::zango::northwind::customer_demographics, id_pgsql >::
  ...
  result< access::object_traits_impl< ::zango::northwind::customer_demographics, id_pgsql >::object_type >
  access::object_traits_impl< ::zango::northwind::customer_demographics, id_pgsql >::
  ...
  unsigned long long access::object_traits_impl< ::zango::northwind::customer_demographics, id_pgsql >::
