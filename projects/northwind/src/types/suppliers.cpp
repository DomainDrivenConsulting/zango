...
const zango::northwind::supplier_id& suppliers::supplier_id() const {
    return supplier_id_;
}

zango::northwind::supplier_id& suppliers::supplier_id() {
    return supplier_id_;
}

void suppliers::supplier_id(const zango::northwind::supplier_id& v) {
    supplier_id_ = v;
}
