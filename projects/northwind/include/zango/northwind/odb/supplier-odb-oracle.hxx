...
#ifndef ZANGO_NORTHWIND_ODB_SUPPLIER_ODB_ORACLE_HXX
#define ZANGO_NORTHWIND_ODB_SUPPLIER_ODB_ORACLE_HXX
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::zango::northwind::supplier, id_oracle, A >
  {
    // supplier_id
    //
  ...
  template <typename A>
  const typename query_columns< ::zango::northwind::supplier, id_oracle, A >::supplier_id_class_::value_type_
  query_columns< ::zango::northwind::supplier, id_oracle, A >::supplier_id_class_::
  value (A::table_name, "\"supplier_id\"", 0, 10);

  template <typename A>
  const typename query_columns< ::zango::northwind::supplier, id_oracle, A >::supplier_id_class_
  query_columns< ::zango::northwind::supplier, id_oracle, A >::supplier_id;
  ...
  template <>
  class access::object_traits_impl< ::zango::northwind::supplier, id_oracle >:
...
#include "zango/northwind/odb/supplier-odb-oracle.ixx"

#include <odb/post.hxx>

#endif // ZANGO_NORTHWIND_ODB_SUPPLIER_ODB_ORACLE_HXX
