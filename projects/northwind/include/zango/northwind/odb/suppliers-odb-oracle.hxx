...
#ifndef ZANGO_NORTHWIND_ODB_SUPPLIERS_ODB_ORACLE_HXX
#define ZANGO_NORTHWIND_ODB_SUPPLIERS_ODB_ORACLE_HXX
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::zango::northwind::suppliers, id_oracle, A >
  {
    // supplier_id
    //
  ...
  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::supplier_id_class_::value_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::supplier_id_class_::
  value (A::table_name, "\"SUPPLIER_ID\"", 0, 10);

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::supplier_id_class_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::supplier_id;

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::company_name_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::
  company_name (A::table_name, "\"COMPANY_NAME\"", 0, 512);

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::contact_name_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::
  contact_name (A::table_name, "\"CONTACT_NAME\"", 0, 512);

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::contact_title_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::
  contact_title (A::table_name, "\"CONTACT_TITLE\"", 0, 512);

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::address_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::
  address (A::table_name, "\"ADDRESS\"", 0, 512);

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::city_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::
  city (A::table_name, "\"CITY\"", 0, 512);

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::region_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::
  region (A::table_name, "\"REGION\"", 0, 512);

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::postal_code_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::
  postal_code (A::table_name, "\"POSTAL_CODE\"", 0, 512);

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::country_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::
  country (A::table_name, "\"COUNTRY\"", 0, 512);

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::phone_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::
  phone (A::table_name, "\"PHONE\"", 0, 512);

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::fax_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::
  fax (A::table_name, "\"FAX\"", 0, 512);

  template <typename A>
  const typename query_columns< ::zango::northwind::suppliers, id_oracle, A >::home_page_type_
  query_columns< ::zango::northwind::suppliers, id_oracle, A >::
  home_page (A::table_name, "\"HOME_PAGE\"", 0, 512);

  template <typename A>
  struct pointer_query_columns< ::zango::northwind::suppliers, id_oracle, A >:
    query_columns< ::zango::northwind::suppliers, id_oracle, A >
  {
  };

  template <>
  class access::object_traits_impl< ::zango::northwind::suppliers, id_oracle >:
    public access::object_traits< ::zango::northwind::suppliers >
  {
    ...
    {
      composite_value_traits< ::zango::northwind::supplier_id, id_oracle >::image_type id_value;
...
#include "zango/northwind/odb/suppliers-odb-oracle.ixx"

#include <odb/post.hxx>

#endif // ZANGO_NORTHWIND_ODB_SUPPLIERS_ODB_ORACLE_HXX
