...
#ifndef ZANGO_NORTHWIND_ODB_EMPLOYEES_ODB_ORACLE_HXX
#define ZANGO_NORTHWIND_ODB_EMPLOYEES_ODB_ORACLE_HXX
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::zango::northwind::employees, id_oracle, A >
  {
    // employee_id
    //
  ...
  template <typename A>
  const typename query_columns< ::zango::northwind::employees, id_oracle, A >::employee_id_class_::value_type_
  query_columns< ::zango::northwind::employees, id_oracle, A >::employee_id_class_::
  value (A::table_name, "\"employee_id_employee_id\"", 0, 10);

  template <typename A>
  const typename query_columns< ::zango::northwind::employees, id_oracle, A >::employee_id_class_
  query_columns< ::zango::northwind::employees, id_oracle, A >::employee_id;
  ...
  query_columns< ::zango::northwind::employees, id_oracle, A >::reports_to;
  ...
  template <>
  class access::object_traits_impl< ::zango::northwind::employees, id_oracle >:
    public access::object_traits< ::zango::northwind::employees >
  {
    ...
    {
      composite_value_traits< ::zango::northwind::employee_id, id_oracle >::image_type id_value;
    ...
    struct image_type
    {
      ...
      // reports_to_
      //
      composite_value_traits< ::zango::northwind::employee_id, id_oracle >::image_type reports_to_value;
...
#include "zango/northwind/odb/employees-odb-oracle.ixx"

#include <odb/post.hxx>

#endif // ZANGO_NORTHWIND_ODB_EMPLOYEES_ODB_ORACLE_HXX
