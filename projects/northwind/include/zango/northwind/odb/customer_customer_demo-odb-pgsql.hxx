...
namespace odb
{
  ...
  template <typename A>
  const typename query_columns< ::zango::northwind::customer_customer_demo, id_pgsql, A >::customer_customer_demo_key_class_::customer_type_class_1_::value_type_
  query_columns< ::zango::northwind::customer_customer_demo, id_pgsql, A >::customer_customer_demo_key_class_::customer_type_class_1_::
  value (A::table_name, "\"customer_type_customer_type_id\"", 0);

  template <typename A>
  const typename query_columns< ::zango::northwind::customer_customer_demo, id_pgsql, A >::customer_customer_demo_key_class_::customer_type_class_1_
  query_columns< ::zango::northwind::customer_customer_demo, id_pgsql, A >::customer_customer_demo_key_class_::customer_type;
