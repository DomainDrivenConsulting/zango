...
#ifndef ZANGO_NORTHWIND_ODB_ORDERS_ODB_ORACLE_HXX
#define ZANGO_NORTHWIND_ODB_ORDERS_ODB_ORACLE_HXX
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::zango::northwind::orders, id_oracle, A >
  {
    // order_id
    //
  ...
  template <typename A>
  const typename query_columns< ::zango::northwind::orders, id_oracle, A >::order_id_class_::value_type_
  query_columns< ::zango::northwind::orders, id_oracle, A >::order_id_class_::
  value (A::table_name, "\"order_id_order_id\"", 0, 10);

  template <typename A>
  const typename query_columns< ::zango::northwind::orders, id_oracle, A >::order_id_class_
  query_columns< ::zango::northwind::orders, id_oracle, A >::order_id;

  template <typename A>
  const typename query_columns< ::zango::northwind::orders, id_oracle, A >::customer_id_class_::value_type_
  query_columns< ::zango::northwind::orders, id_oracle, A >::customer_id_class_::
  value (A::table_name, "\"customer_id_customer_id\"", 0, 10);

  template <typename A>
  const typename query_columns< ::zango::northwind::orders, id_oracle, A >::customer_id_class_
  query_columns< ::zango::northwind::orders, id_oracle, A >::customer_id;

  template <typename A>
  const typename query_columns< ::zango::northwind::orders, id_oracle, A >::employee_id_class_::value_type_
  query_columns< ::zango::northwind::orders, id_oracle, A >::employee_id_class_::
  value (A::table_name, "\"employee_id_employee_id\"", 0, 10);

  template <typename A>
  const typename query_columns< ::zango::northwind::orders, id_oracle, A >::employee_id_class_
  query_columns< ::zango::northwind::orders, id_oracle, A >::employee_id;
  ...
  template <>
  class access::object_traits_impl< ::zango::northwind::orders, id_oracle >:
    public access::object_traits< ::zango::northwind::orders >
  {
    ...
    {
      composite_value_traits< ::zango::northwind::order_id, id_oracle >::image_type id_value;
...
#include "zango/northwind/odb/orders-odb-oracle.ixx"

#include <odb/post.hxx>

#endif // ZANGO_NORTHWIND_ODB_ORDERS_ODB_ORACLE_HXX
