...
#ifndef ZANGO_NORTHWIND_ODB_TERRITORY_ODB_ORACLE_HXX
#define ZANGO_NORTHWIND_ODB_TERRITORY_ODB_ORACLE_HXX
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::zango::northwind::territory, id_oracle, A >
  {
    // territory_id
    //
  ...
  value (A::table_name, "\"territory_id_territory_id\"", 0, 512);

  template <typename A>
  const typename query_columns< ::zango::northwind::territory, id_oracle, A >::territory_id_class_
  query_columns< ::zango::northwind::territory, id_oracle, A >::territory_id;
  ...
  query_columns< ::zango::northwind::territory, id_oracle, A >::region_id;

  template <typename A>
  struct pointer_query_columns< ::zango::northwind::territory, id_oracle, A >:
    query_columns< ::zango::northwind::territory, id_oracle, A >
  {
  };

  template <>
  class access::object_traits_impl< ::zango::northwind::territory, id_oracle >:
    public access::object_traits< ::zango::northwind::territory >
  {
    ...
    {
      composite_value_traits< ::zango::northwind::territory_id, id_oracle >::image_type id_value;
...
#include "zango/northwind/odb/territory-odb-oracle.ixx"

#include <odb/post.hxx>

#endif // ZANGO_NORTHWIND_ODB_TERRITORY_ODB_ORACLE_HXX
