...
#ifndef ZANGO_NORTHWIND_ODB_EMPLOYEE_TERRITORIES_ODB_PGSQL_HXX
#define ZANGO_NORTHWIND_ODB_EMPLOYEE_TERRITORIES_ODB_PGSQL_HXX
...
#include "zango/northwind/odb/employee_territories_key-odb-pgsql.hxx"
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::zango::northwind::employee_territories, id_pgsql, A >
  {
  ...
  query_columns< ::zango::northwind::employee_territories, id_pgsql, A >::employee_territories_key_class_::employee_id;
  ...
  query_columns< ::zango::northwind::employee_territories, id_pgsql, A >::employee_territories_key_class_::territory_id;

  template <typename A>
  const typename query_columns< ::zango::northwind::employee_territories, id_pgsql, A >::employee_territories_key_class_
  query_columns< ::zango::northwind::employee_territories, id_pgsql, A >::employee_territories_key;

  template <typename A>
  struct pointer_query_columns< ::zango::northwind::employee_territories, id_pgsql, A >:
    query_columns< ::zango::northwind::employee_territories, id_pgsql, A >
  {
  };

  template <>
  class access::object_traits_impl< ::zango::northwind::employee_territories, id_pgsql >:
    public access::object_traits< ::zango::northwind::employee_territories >
  {
    public:
    struct id_image_type
    {
      composite_value_traits< ::zango::northwind::employee_territories_key, id_pgsql >::image_type id_value;
    ...
    struct image_type
    {
      ...
      //
      composite_value_traits< ::zango::northwind::employee_territories_key, id_pgsql >::image_type employee_territories_key_value;
...
#include "zango/northwind/odb/employee_territories-odb-pgsql.ixx"

#include <odb/post.hxx>

#endif // ZANGO_NORTHWIND_ODB_EMPLOYEE_TERRITORIES_ODB_PGSQL_HXX
